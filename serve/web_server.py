    ...
    with gr.Blocks(title="mPLUG-Owl🦉", css=css) as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=6):
                chatbot = grChatbot(elem_id="chatbot", visible=True).style(height=1000)
...
if __name__ == "__main__":
    ...
    demo = build_demo()
    demo.queue(concurrency_count=args.concurrency_count, status_update_rate=10, api_open=False).launch(server_name=args.host, debug=True, server_port=args.port, share=False)